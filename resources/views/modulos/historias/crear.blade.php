        ...
        <div class="card-body">
                ...
                <div id="div_fil_1" style="width:95%; margin:0 auto">
                    ...
                    <div class="row p-0">   
                        <div class="col-lg-4 px-1">
                            ...
                            {!! Form::text('title', ucwords(strtolower($cita['cita']->paciente)), array('class' => 'mat-input', 'required' => 'required')) !!}
                            </div>
                        </div>     
                        <div class="col-lg-2 px-1">
                            <div class="mat-div is-completed">
                            <label for="first-name" class="mat-label">Edad</label>
                            {!! Form::text('title', $edad.' años' ?? 0, array('class' => 'mat-input', 'required' => 'required' )) !!}
                            </div>
                        </div>   
                        <div class="col-lg-2 px-1">
                            <div class="mat-div is-completed">
                            <label for="first-name" class="mat-label">Fecha de cita</label>
                            {!! Form::text('title',$fechaCita, array('class' => 'mat-input', 'required' => 'required')) !!}
                            </div>
                        </div>     
                        <div class="col-lg-2 px-1">
                            <div class="mat-div">
                            <label for="first-name" class="mat-label">Ejerc. Activos</label>
                            {!! Form::text('title', '', array('class' => 'mat-input', 'required' => 'required' )) !!}
                            </div>
                        </div>   
                        <div class="col-lg-2 px-1">
                            <div class="mat-div">
                            <label for="first-name" class="mat-label">Ejerc. Realizados</label>
                            {!! Form::text('title', '', array('class' => 'mat-input', 'required' => 'required' )) !!}
                            </div>
                        </div> 
                    </div>
            ...
            <form action="{{ route('modulos.pacientes.insert') }}" method="POST">
                ...
                <div class="tab-content p-0" style="border:1px solid #dee2e6; border-top: none">
                    ...
                    <div class="tab-pane container p-4" id="tab2-form">        @include('modulos.historias.tabs-form.tab2')</div>
                    <div class="tab-pane container p-4" id="tab3-form">        @include('modulos.historias.tabs-form.tab3')</div>
                    <div class="tab-pane container p-4" id="tab4-form">        @include('modulos.historias.tabs-form.tab4')</div>
                    <div class="tab-pane container p-4" id="tab5-form">        @include('modulos.historias.tabs-form.tab5')</div>
                    <div class="tab-pane container p-4" id="tab6-form">        @include('modulos.historias.tabs-form.tab6')</div>
                    <div class="tab-pane container p-4" id="tab7-form">        @include('modulos.historias.tabs-form.tab7')</div>
