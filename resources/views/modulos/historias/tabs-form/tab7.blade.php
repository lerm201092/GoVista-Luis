                ...
                <tbody>
                    ...
                    ?>
                        <td class="px-1 py-3">
                            <div class="form-check">
                                <label class="form-check-label pt-4">
                                    <input name ="id_exercise[<?=($i)?>]" type="checkbox" class="form-check-input mr-2" value="<?=($i)?>" style="width:25px; height:25px;margin-top:-2px;">&nbsp;&nbsp;&nbsp;Ejecicio <?=($i+1)?> 
                                </label>
                        ...
                        <td class="px-1 py-3 text-center">
                            <div class="mat-div">
                                <label for="first-name" class="mat-label"> . . . </label>
                                {{ Form::select('duration['.$i.']', $nosesiones , '', array('class' => 'mat-input')) }}
                            </div>
                        </td>
                    <?php
                            echo "</tr>";
...
function cargarModal(nombre, descripcion, i){
    ...
    $("#img_ejer").attr("src", "{{ asset('/img/juegos') }}/"+(i+1)+".gif");
    $("#sp_name").text(nombre);
