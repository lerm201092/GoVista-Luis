        ...
        <div id="div_fil_1" style="width:95%; margin:0 auto">
            ...
            <div class="row p-0">   
                <div class="col-lg-3">
                    ...
                    {!! Form::text('av_tiplen', '', array('class' => 'mat-input', 'required' => 'required')) !!}
                    </div>
                </div>     
                <div class="col-lg-3">
                    <div class="mat-div">
                    <label for="first-name" class="mat-label">Color</label>
                    {!! Form::text('av_color', '', array('class' => 'mat-input', 'required' => 'required' )) !!}
                    </div>
                </div>   
                <div class="col-lg-3">
                    <div class="mat-div">
                    <label for="first-name" class="mat-label">Filtro</label>
                    {!! Form::text('av_filtro', '', array('class' => 'mat-input', 'required' => 'required')) !!}
                    </div>
                </div>     
                <div class="col-lg-3">
                    <div class="mat-div">
                    <label for="first-name" class="mat-label">Uso de lentes</label>
                    {!! Form::text('av_usolen', '', array('class' => 'mat-input', 'required' => 'required' )) !!}
                    </div>
                </div>   
            </div>
        </div>
        ...
        <div id="div_fil_2" style="width:95%; margin:0 auto">
            ...
            <div class="row border p-0 pb-4 mt-4">             
                <div class="col-lg-2 m-0 p-0">
                    ...
                    {!! Form::text('av_esfera_oi', '', array('class' => 'mat-input', 'required' => 'required')) !!}
                    </div>
                    <div class="mat-div mx-2">
                        <label for="first-name" class="mat-label text-center">Ojo Derecho</label>
                        {!! Form::text('av_esfera_od', '', array('class' => 'mat-input', 'required' => 'required')) !!}
                    </div>
                </div>   
                ...
                <div class="col-lg-2 m-0 p-0">
                    ...
                    <div class="mat-div mx-2">
                        <label for="first-name" class="mat-label text-center">Ojo Izquierdo</label>
                        {!! Form::text('av_cilindro_oi', '', array('class' => 'mat-input', 'required' => 'required')) !!}
                    </div>
                    <div class="mat-div mx-2">
                        <label for="first-name" class="mat-label text-center">Ojo Derecho</label>
                        {!! Form::text('av_cilindro_od', '', array('class' => 'mat-input', 'required' => 'required')) !!}
                    </div>
                </div> 
                ...
                <div class="col-lg-2 m-0 p-0">
                    ...
                    <div class="mat-div mx-2">
                        <label for="first-name" class="mat-label text-center">Ojo Izquierdo</label>
                        {!! Form::text('av_eje_oi', '', array('class' => 'mat-input', 'required' => 'required')) !!}
                    </div>
                    <div class="mat-div mx-2">
                        <label for="first-name" class="mat-label text-center">Ojo Derecho</label>
                        {!! Form::text('av_eje_od', '', array('class' => 'mat-input', 'required' => 'required')) !!}
                    </div>
                </div>   
                ...
                <div class="col-lg-2 m-0 p-0">
                    ...
                    <div class="mat-div mx-2">
                        <label for="first-name" class="mat-label text-center">Ojo Izquierdo</label>
                        {!! Form::text('av_prisma_oi', '', array('class' => 'mat-input', 'required' => 'required')) !!}
                    </div>
                    <div class="mat-div mx-2">
                        <label for="first-name" class="mat-label text-center text-center">Ojo Derecho</label>
                        {!! Form::text('av_prisma_od', '', array('class' => 'mat-input', 'required' => 'required')) !!}
                    </div>
                </div>  
                ...
                <div class="col-lg-4 m-0 p-0">
                    ...
                    <div class="mat-div mx-2">
                        <label for="first-name" class="mat-label text-center">Ojo Izquierdo</label>
                        {!! Form::text('av_base_oi', '', array('class' => 'mat-input', 'required' => 'required')) !!}
                    </div>
                    <div class="mat-div mx-2">
                        <label for="first-name" class="mat-label text-center">Ojo Derecho</label>
                        {!! Form::text('av_base_od', '', array('class' => 'mat-input', 'required' => 'required')) !!}
                    </div>
                </div> 
            </div>
            <!-- / FILA 1 -->
                    ...
                    <div class="row">                        
                        <div class="col-6 p-1">
                            ...
                            <div class="mat-div mx-1">
                                <label for="first-name" class="mat-label text-center">Ojo Izquierdo</label>
                                {!! Form::text('av_avc_cc_oi', '', array('class' => 'mat-input', 'required' => 'required')) !!}
                            </div>
                            <div class="mat-div mx-1">
                                <label for="first-name" class="mat-label text-center">Ojo Derecho</label>
                                {!! Form::text('av_avc_cc_od', '', array('class' => 'mat-input', 'required' => 'required')) !!}
                            </div>
                        </div>
                        <div class="col-6 p-1">
                            ...
                            <div class="mat-div mx-1">
                                <label for="first-name" class="mat-label text-center">Ojo Izquierdo</label>
                                {!! Form::text('av_avc_sc_oi', '', array('class' => 'mat-input', 'required' => 'required')) !!}
                            </div>
                            <div class="mat-div mx-1">
                                <label for="first-name" class="mat-label text-center">Ojo Derecho</label>
                                {!! Form::text('av_avc_sc_od', '', array('class' => 'mat-input', 'required' => 'required')) !!}
                            </div>
                        </div>
                    </div>                  
                </div>   
                ...
                <div class="col-lg-5 m-0 p-0">
                    ...
                    <div class="row">                        
                        <div class="col-6 p-1">
                            ...
                            <div class="mat-div mx-1">
                                <label for="first-name" class="mat-label text-center">Ojo Izquierdo</label>
                                {!! Form::text('title', '', array('av_avl_cc_oi' => 'mat-input', 'required' => 'required')) !!}
                            </div>
                            <div class="mat-div mx-1">
                                <label for="first-name" class="mat-label text-center">Ojo Derecho</label>
                                {!! Form::text('title', '', array('av_avl_cc_od' => 'mat-input', 'required' => 'required')) !!}
                            </div>
                        </div>
                        <div class="col-6 p-1">
                            <p class="col-12 text-center font-weight-bold mb-0 mt-3">SC</p>
                            <div class="mat-div mx-1">
                                <label for="first-name" class="mat-label text-center">Ojo Izquierdo</label>
                                {!! Form::text('av_avl_sc_oi', '', array('class' => 'mat-input', 'required' => 'required')) !!}
                            </div>
                            <div class="mat-div mx-1">
                                <label for="first-name" class="mat-label text-center">Ojo Derecho</label>
                                {!! Form::text('av_avl_sc_od', '', array('class' => 'mat-input', 'required' => 'required')) !!}
                            </div>
                        </div>
                    </div>                  
                </div>
                    ...
                    <div class="row">                        
                        <div class="col-12 p-1">
                            ...
                            <div class="mat-div mx-1">
                                ...
                                {!! Form::text('av_ojodom', '', array('class' => 'mat-input', 'required' => 'required')) !!}
                            </div>
                            <div class="mat-div mx-1">
                                <label for="first-name" class="mat-label text-center">MANO DOMINANTE</label>
                                {!! Form::text('av_manodom', '', array('class' => 'mat-input', 'required' => 'required')) !!}
                            </div>
                        </div>
                    </div>  
                </div>  
                ...
                <div class="col-lg-6 m-0 p-0">
                    ...
                    <div class="row">                        
                        <div class="col-12 p-1">
                            ...
                            <div class="mat-div mx-1">
                                <label for="first-name" class="mat-label text-center">Ojo Izquierdo</label>
                                {!! Form::text('av_angkap_oi', '', array('class' => 'mat-input', 'required' => 'required')) !!}
                            </div>
                            <div class="mat-div mx-1">
                                <label for="first-name" class="mat-label text-center">Ojo Derecho</label>
                                {!! Form::text('av_angkap_od', '', array('class' => 'mat-input', 'required' => 'required')) !!}
                            </div>
                        </div>
                    </div>                  
                </div>   
                    ...
                    <div class="row">                        
                        <div class="col-12 p-1">
                            ...
                            <div class="mat-div mx-1">
                                ...
                                {!! Form::text('av_ppc_or', '', array('class' => 'mat-input', 'required' => 'required')) !!}
                            </div>
                            <div class="mat-div mx-1">
                                <label for="first-name" class="mat-label text-center">SF</label>
                                {!! Form::text('av_ppc_sf', '', array('class' => 'mat-input', 'required' => 'required')) !!}
                            </div>
                        </div>
                    </div>                  
                </div>
                ...
                <div class="col-lg-4 m-0 p-0">
                    ...
                    <div class="row">                        
                        <div class="col-12 p-1">
                            ...
                            <div class="mat-div mx-1">
                                <label for="first-name" class="mat-label text-center">Ojo Izquierdo</label>
                                {!! Form::text('av_fija_oi', '', array('class' => 'mat-input', 'required' => 'required')) !!}
                            </div>
                            <div class="mat-div mx-1">
                                <label for="first-name" class="mat-label text-center">Ojo Derecho</label>
                                {!! Form::text('av_fija_od', '', array('class' => 'mat-input', 'required' => 'required')) !!}
                            </div>
                        </div>
                    </div>                  
                </div>   
                    ...
                    <div class="row">                        
                        <div class="col-12 p-1">
                            ...
                            <div class="mat-div mx-1">
                                ...
                                {!! Form::text('av_ctest_lej', '', array('class' => 'mat-input', 'required' => 'required')) !!}
                            </div>
                            <div class="mat-div mx-1">
                                <label for="first-name" class="mat-label text-center">Cerca</label>
                                {!! Form::text('av_ctest_cer', '', array('class' => 'mat-input', 'required' => 'required')) !!}
                            </div>
                        </div>
                    </div>                  
                </div>
                    ...
                    <div class="row">                        
                        <div class="col-12 p-1">
                            ...
                            <div class="mat-div mx-1">
                                ...
                                {!! Form::text('av_distint', '', array('class' => 'mat-input', 'required' => 'required')) !!}
                            </div>
                        </div>
                    </div>                  
                </div>  
                    ...
                    <div class="row">                        
                        <div class="col-12 p-1">
                            ...
                            <div class="mat-div mx-1">
                                ...
                                {!! Form::text('av_obser', '', array('class' => 'mat-input', 'required' => 'required')) !!}
                            </div>
                        </div>
                    </div>                  
                </div>
